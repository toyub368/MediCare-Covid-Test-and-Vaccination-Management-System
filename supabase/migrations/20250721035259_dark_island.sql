...
('Apollo Health Care', 'apollo@hospital.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '9876543212', '789 Health Street', 'Bangalore', 'Karnataka', '560001', 'LIC003', 'approved');
...
(3, 'Covaxin', 120, 300.00),
(3, 'Covishield', 200, 250.00);
...
('Jane Smith', 'jane@patient.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '9876543213', '1985-05-15', 'female', '456 Pine Avenue', 'Delhi', 'Delhi', '110002', '123456789013');

-- Insert sample test bookings
INSERT INTO test_bookings (patient_id, hospital_id, test_type, booking_date, booking_time, status, test_result, price) VALUES 
(1, 1, 'RT-PCR', '2024-01-15', '10:00:00', 'completed', 'negative', 500.00),
(2, 2, 'Rapid Antigen', '2024-01-16', '14:00:00', 'pending', 'pending', 300.00);

-- Insert sample vaccination bookings
INSERT INTO vaccination_bookings (patient_id, hospital_id, vaccine_name, dose_number, booking_date, booking_time, status, certificate_number) VALUES 
(1, 1, 'Covishield', '1', '2024-01-10', '11:00:00', 'completed', 'CERT2024123456'),
(2, 2, 'Covaxin', '1', '2024-01-12', '15:00:00', 'approved', NULL);